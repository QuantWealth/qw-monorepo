 ...
 * 
 * @param hostname - Address of the mongodb instance to connect to. Default: "mongodb://localhost/app"
 *
...
export async function connectIndexerDB(hostname?: string) {
  await mongoose.connect(hostname ? hostname : "mongodb://localhost/app")
}
